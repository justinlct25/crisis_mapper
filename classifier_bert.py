...
def classify_posts_with_bert(extracted_posts_csv=None):
    ...
    output_file = f"data/classified_posts/classified_{len(df)}_{source}_posts_semantic_{latest_time_formatted}.csv"
