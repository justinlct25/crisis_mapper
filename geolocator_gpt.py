...
latest_file, latest_time = get_latest_file('data/classified_posts', f"classified_posts_{source}_semantic")
...
output_file = f"data/geolocated_posts/geolocated_posts_{source}_semantic_{latest_time_formatted}.csv"
...
heatmap_file = f"outputs/crisis_heatmap_{source}_semantic_{latest_time_formatted}.html"
